...
<head>
    ...
    <title>Dongari certificate</title>
...
<hr class="hr_tag" color="black">
            ...
            <div class="input_field">
                <label for="input">last year Leaving certificate <p class="p" style="font-size: 15px;"> (चालू वर्षाचा शाळा सोडल्याचा दाखला   ) </p> </label>
                <input type="file" class="input"    id="leaving_certificate"
                    name="leaving_certificate">
            </div>
            <h2 style="color: red;text-align:center; border:green solid;border-radius:50px">OR</h2>



            <div class="input_field">
                <label for="input"> Bonafide certificate <p class="p" style="font-size: 15px;"> (बोनाफाईड ) </p> </label>
                <input type="file" class="input"    id="bonafide"
                    name="bonafide">
            </div>
            <hr class="hr_tag" color="black">
