...
<head>
    ...
    <title>Non-Creamy layer certificate</title>
...
<a href="../../../index.php" ><img src="home.png" alt="home" style="width:30px;display:flex;    margin: auto" ><p  style="width:30px;display:flex;    margin: auto">home</p></a>
    <div class="container">
        ...
        <div class="heading">
            <h1>Non-Creamy layer certificate & Central cast certificate</h1>
            <h3 >नॉन क्रिमीलेअर व सेंट्रल जातीचे दाखले   </h3>
            <h4 >(SC / ST / NT)</h4>
        </div>
...
<hr class="hr_tag" color="black">
          ...
          <hr class="hr_tag" color="black">
            ...
            <div class="input_field">
                <label for="input">Tahasil 3 year income certificate<p class="p" style="font-size: 15px;"> (तहसिलदार यांचा ३ वर्षाचा उत्पन्नाचा दाखला) </p> </label>
            ...
            <hr class="hr_tag" color="black">
            <p class="hiper"> if you dont have income certificate then apply <a href="../income_certificate/income_certificate.php">here </a>first</p>
            <hr class="hr_tag" color="black">


            <div class="input_field">
                <label for="input">Cast certificate  <p class="p" style="font-size: 15px;"> (	जातीचे दाखला) </p> </label>
                <input type="file" class="input"   required id="cast_certificate"
