...
<hr class="hr_tag" color="black">
            ...
            <div class="input_field">
                <label for="input"> Income certificate from Talathi<p class="p" style="font-size: 15px;"> (तलाठीयांचा उत्पन्नाचा दाखला  ) </p> </label>
                <input type="file" class="input" maxlength="6"  required id="talathi_income_certificate"
                    name="talathi_income_certificate">
            </div>
            <hr class="hr_tag" color="black">
