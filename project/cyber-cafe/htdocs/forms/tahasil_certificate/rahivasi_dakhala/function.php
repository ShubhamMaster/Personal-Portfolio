...
// img uplode
            ...
            $imageExtension = strtolower(end($imageExtension));
                ...
                $imageExtension = strtolower(end($imageExtension));
                    ...
                    $filename = $_FILES["bonafide"]["name"];
                    $filesize =$_FILES["bonafide"]["size"];
                    $tmpname =$_FILES["bonafide"]["tmp_name"];
                    $validImgExtension =['jpg', 'jepg', 'png', 'pdf'];
                    $imageExtension = explode('.',$filename);
                    $imageExtension = strtolower(end($imageExtension));
                    
                        $bonafide = uniqid();
                        $bonafide .= '.'.$imageExtension;
                        move_uploaded_file($tmpname, '../../../login/database/'.$bonafide);
...
// INSERT INTO `data` (`form_type`, `first_name`, `middel_name`, `last_name`, `gender`, `contact`, `email`, `state`, `district`, `city`, `vilage`, `pincode`, `talathi_income_certificate`, `adhar_front`, `adhar_back`, `ration_card`, `leaving_certificate`, `bonafide`, `date`) VALUES ('$type', '$first_name', '$middel_name', '$last_name', '$gender ', '$contact ', '$email ', '$state', '$district ', '$city', '$vilage', '$pincode', '$adhar_front ', '$adhar_back', '$ration_card', '$leaving_certificate', '$bonafide', current_timestamp());
    ...
    $sql = "INSERT INTO `data` (`form_type`, `first_name`, `middel_name`, `last_name`, `gender`, `contact`, `email`, `state`, `district`, `city`, `vilage`, `pincode`, `adhar_front`, `adhar_back`, `ration_card`, `leaving_certificate`, `bonafide`, `father_leaving_certificate`, `grandfather_leaving_certificate`,`date`) VALUES ( '$type', '$first_name', '$middel_name', '$last_name', '$gender', '$contact', '$email', '$state', '$district', '$city', '$vilage', '$pincode', '$adhar_front', '$adhar_back', '$ration_card', '$leaving_certificate', '$bonafide', '$father_leaving_certificate', '$grandfather_leaving_certificate',current_timestamp())";
