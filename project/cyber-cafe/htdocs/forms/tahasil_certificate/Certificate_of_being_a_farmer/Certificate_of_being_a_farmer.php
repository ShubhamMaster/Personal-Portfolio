...
<head>
    ...
    <title>Certificate of being a farmer</title>
...
<a href="../../../index.php" ><img src="home.png" alt="home" style="width:30px;display:flex;    margin: auto" ><p  style="width:30px;display:flex;    margin: auto">home</p></a>
    <div class="container">
        ...
        <div class="heading">
            <h1>Certificate of being a farmer</h1>
            <h3 > शेतकरी असल्याचा दाखला  </h3>
...
<hr class="hr_tag" color="black">
            ...
            <p style="color: white;border:2px solid green;margin:3px;padding:3px;background-color:green">Orignal</p>
                <label for="input">7/12 utara<p class="p" style="font-size: 15px;"> (	७/१२ उतारा ) </p> </label>
            ...
            <div class="input_field">
            <p style="color: white;border:2px solid green;margin:3px;padding:3px;background-color:green">Orignal</p>
                <label for="input"> latest 8 A <p class="p" style="font-size: 15px;"> ( चालू ८ अ  ) </p> </label>
          ...
          <hr class="hr_tag" color="black">
            ...
            <div class="input_field">
                <label for="input">Talathi sign Certificate of being a farmer <p class="p" style="font-size: 15px;"> (तलाठीयांचा शेतकरी असल्याचा दाखला ) </p> </label>
                <input type="file" class="input"   required id="talathi_farmer_certificate"
                    name="talathi_farmer_certificate">
            </div>
            <hr class="hr_tag" color="black">
