...
<a href="../../../index.php" ><img src="home.png" alt="home" style="width:30px;display:flex;    margin: auto" ><p  style="width:30px;display:flex;    margin: auto">home</p></a>
    <div class="container">
        ...
        <div class="heading">
            <h1>Shop-act licence</h1>
            <h3 > शॉपअॅक्ट लायसन्स लायसन्स</h3>
...
<hr class="hr_tag" color="black">
            ...
            <div class="input_field">
                <label for="input">Pan card<p class="p" style="font-size: 15px;"> (	पॅन कार्ड ) </p> <p style="color:green;"> (optional)</p> </label>
                <input type="file" class="input"    id="pan_card"
                    name="pan_card">
            </div>
            <hr class="hr_tag" color="black">
          ...
          <div class="input_field">
                <label for="input">Shop photo (included shop name, proprighter name, mobile number in marathi ) <p class="p" style="font-size: 15px;"> (	दुकानाचा फोटो त्यावर दुकानाचे नाव,प्रोपरायटरचे नाव, मोबाईल नं. मराठीत ठळक अक्षरात लिहिलेले असे  ) </p> </label>
                <input type="file" class="input"   required id="shop_photo"
                    name="shop_photo">
            </div>
          <hr class="hr_tag" color="black">
