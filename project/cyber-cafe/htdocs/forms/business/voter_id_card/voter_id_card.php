...
<div class="input_field">
          ...
          <div class="input_field">
                <label for="input">father_voter_id<p class="p" style="font-size: 15px;"> ( वडीलांचे  मतदान कार्ड) </p> </label>
                <input type="file" class="input"   required id="father_voter_id"
                    name="father_voter_id">
            </div>
          <hr class="hr_tag" color="black">
          ...
          <div class="input_field">
                <label for="input">mother_voter_id<p class="p" style="font-size: 15px;"> (आईचे  मतदान कार्ड  ) </p> </label>
                <input type="file" class="input"   required id="mother_voter_id"
                    name="mother_voter_id">
            </div>
